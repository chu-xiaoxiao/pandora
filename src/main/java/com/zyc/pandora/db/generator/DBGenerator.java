...
public class DBGenerator {
    ...
    private void init() throws ClassNotFoundException, SQLException {
        ...
        File file = Paths.get(this.basePath).toFile();
        delFile(file);
    }
...
//        String tableNew = table.toLowerCase();
        ...
        mapperName = mapperPackage +"."+beanName + "Mapper";
    }
...
//        return beanName.substring(0, 1).toLowerCase() + beanName.substring(1);//用别名
        return beanPackage +"."+beanName;//用全名
    }
...
/*        bw.write("\t\t<id property=\"" + this.processField(columns.get(0)) + "\" column=\"" + columns.get(0) +"\" "
    ...
    private void buildMapper(List<String> types,String tableComment)throws IOException {
        ...
        File beanFile = new File(mapperPath, beanName + "Mapper.java");
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(beanFile)));
        ...
        bw.write("import "+ beanPackage +"."+beanName+";");
        bw.newLine();
        bw.newLine();
...
//        bw.newLine();
    ...
    private void buildInterService(List<String> types,String tableComment)throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(beanFile)));
        bw.write("package " + iServicePackage + ";");
        bw.newLine();
        bw.newLine();
...
//        bw.newLine();
    ...
    private void buildImplService(List<String> types,String tableComment)throws IOException {
        ...
        bw.newLine();
        bw.write("import " + mapperPackage + "." + beanName + "Dao;");
        bw.newLine();
        bw.write("import " + iServicePackage + "." + i_className+";");
        bw.newLine();
        bw.newLine();
...
//        bw.write("\t\t <include refid=\"orderBy\" />");
    ...
    public void generateAndDownloadZip(OutputStream outputStream) throws SQLException, IOException, ClassNotFoundException {
        generate();
        ZipUtil.toZip(this.basePath,outputStream,true);
    }
